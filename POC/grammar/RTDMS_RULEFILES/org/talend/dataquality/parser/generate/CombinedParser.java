...
public class CombinedParser extends Parser {
	...
	// $ANTLR start "text"
	// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:38:1: text : ( separator )* ( ( extended | basic | undefined ) ( separator )* )* ;
	public final void text() throws RecognitionException {
		try {
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:39:3: ( ( separator )* ( ( extended | basic | undefined ) ( separator )* )* )
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:40:3: ( separator )* ( ( extended | basic | undefined ) ( separator )* )*
			{
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:40:3: ( separator )*
			loop1:
			while (true) {
				int alt1=2;
			...
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:41:3: ( ( extended | basic | undefined ) ( separator )* )*
			loop4:
			while (true) {
				int alt4=2;
				...
				switch (alt4) {
				case 1 :
					// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:42:5: ( extended | basic | undefined ) ( separator )*
					{
					// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:42:5: ( extended | basic | undefined )
					int alt2=3;
					switch ( input.LA(1) ) {
					case CJK:
					case CURRENCY:
					...
					switch (alt2) {
						case 1 :
							// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:42:6: extended
							{
							...
							break;
						case 2 :
							// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:42:17: basic
							{
							...
							break;
						case 3 :
							// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:42:25: undefined
							{
					...
					// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\RTDMS_RULEFILES\\grammar\\Combined.g:43:5: ( separator )*
					loop3:
					while (true) {
						int alt3=2;
