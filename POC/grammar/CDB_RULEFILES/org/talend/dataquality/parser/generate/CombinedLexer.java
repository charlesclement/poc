...
public class CombinedLexer extends Lexer {
	...
	public final void mWHITESPACE() throws RecognitionException {
		try {
			...
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:49:3: ( ( ' ' | '\\r' | '\\n' | '\\t' | '\\f' ) )
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:50:3: ( ' ' | '\\r' | '\\n' | '\\t' | '\\f' )
			{
	...
	public final void mCHAR_IGNORED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:55:3: ( ( '.' | ',' | ':' | ';' | '!' | '?' | '\"' | '\\'' | '(' | ')' ) )
			// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:56:3: ( '.' | ',' | ':' | ';' | '!' | '?' | '\"' | '\\'' | '(' | ')' )
			{
	...
	public void mTokens() throws RecognitionException {
		// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:1:8: ( WHITESPACE | CHAR_IGNORED | BasicLexer. Tokens )
		int alt1=3;
		...
		switch (alt1) {
			case 1 :
				// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:1:10: WHITESPACE
				{
				mWHITESPACE(); 
				...
				break;
			case 2 :
				// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:1:21: CHAR_IGNORED
				{
				mCHAR_IGNORED(); 
				...
				break;
			case 3 :
				// D:\\TIC_Volvo\\TIC\\workspace\\.repositories\\212614823\\master\\POC\\grammar\\CDB_RULEFILES\\grammar\\Combined.g:1:34: BasicLexer. Tokens
				{
				gBasicLexer.mTokens(); 
